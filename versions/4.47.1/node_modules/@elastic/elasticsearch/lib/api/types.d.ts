...
export declare type Time = string | integer;
...
export declare type AggregationsTermsAggregationOrder = Record<Field, SortOrder> | Record<Field, SortOrder>[];
...
export declare type MappingRuntimeFields = Record<Field, MappingRuntimeField | MappingRuntimeField[]>;
...
export declare type IndicesIndexCheckOnStartup = boolean | 'false' | 'checksum' | 'true';
...
export declare type WatcherTimeOfDay = string | WatcherHourAndMinute;
